...
/// @nodoc
mixin _$Analyze {
  String get dateScope => throw _privateConstructorUsedError;
...
abstract class $AnalyzeCopyWith<$Res> {
  ...
  $Res call(
      {String dateScope, int selectedChipIndex, double totalTrackedHours});
}
...
class _$AnalyzeCopyWithImpl<$Res> implements $AnalyzeCopyWith<$Res> {
  ...
  @override
  $Res call({
    Object? dateScope = freezed,
    Object? selectedChipIndex = freezed,
    Object? totalTrackedHours = freezed,
  }) {
    return _then(_value.copyWith(
      dateScope: dateScope == freezed
          ? _value.dateScope
          : dateScope // ignore: cast_nullable_to_non_nullable
              as String,
      selectedChipIndex: selectedChipIndex == freezed
...
class _$_Analyze extends _Analyze {
  ...
  @override
  String toString() {
    return 'Analyze(dateScope: $dateScope, selectedChipIndex: $selectedChipIndex, totalTrackedHours: $totalTrackedHours)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _Analyze &&
            const DeepCollectionEquality().equals(other.dateScope, dateScope) &&
            const DeepCollectionEquality()
                .equals(other.selectedChipIndex, selectedChipIndex) &&
            const DeepCollectionEquality()
  ...
  int get hashCode => Object.hash(
      runtimeType,
      const DeepCollectionEquality().hash(dateScope),
      const DeepCollectionEquality().hash(selectedChipIndex),
      const DeepCollectionEquality().hash(totalTrackedHours));
...
abstract class _Analyze extends Analyze {
  const factory _Analyze(
      {required final String dateScope,
      required final int selectedChipIndex,
      required final double totalTrackedHours}) = _$_Analyze;
