...
import 'application/auth/authBloc/auth_bloc.dart' as _i10;
import 'application/auth/forgotPasswordBloc/forgot_password_bloc.dart' as _i11;
import 'application/auth/registerAndLoginBloc/register_and_login_bloc.dart'
    as _i9;
import 'application/note/noteWatcherBloc/note_watcher_bloc.dart' as _i7;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i9.RegisterAndLoginBloc>(
      () => _i9.RegisterAndLoginBloc(get<_i5.IAuthRepository>()));
  gh.factory<_i10.AuthBloc>(() => _i10.AuthBloc(get<_i5.IAuthRepository>()));
  gh.factory<_i11.ForgotPasswordBloc>(
      () => _i11.ForgotPasswordBloc(get<_i5.IAuthRepository>()));
  return get;
}

class _$InfrastructureInjectableModule
    extends _i12.InfrastructureInjectableModule {}
