...
import 'application/auth/authBloc/auth_bloc.dart' as _i19;
import 'application/auth/forgotPasswordBloc/forgot_password_bloc.dart' as _i21;
import 'application/auth/registerAndLoginBloc/register_and_login_bloc.dart'
    as _i15;
import 'application/auth/verifyEmailBloc/verify_email_bloc.dart' as _i18;
import 'application/core/internetConnectionBloc/internet_connection_bloc.dart'
    as _i11;
import 'application/core/searchBloc/search_bloc.dart' as _i29;
...
import 'domain/core/internetConnection/i_internet_connection_service.dart'
    as _i9;
import 'domain/note/i_note_local_repository.dart' as _i22;
import 'domain/timer/i_time_local_repository.dart' as _i24;
...
import 'infrastructure/note/note_local_repository.dart' as _i23;
import 'infrastructure/note/note_local_service.dart' as _i14;
import 'infrastructure/timer/time_local_repository.dart' as _i25;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i17.TimeLocalService>(
      () => _i17.TimeLocalService(get<_i12.MyDatabase>()));
  gh.factory<_i18.VerifyEmailBloc>(
      () => _i18.VerifyEmailBloc(get<_i7.IAuthRemoteService>()));
  gh.factory<_i19.AuthBloc>(() => _i19.AuthBloc(
      get<_i7.IAuthRemoteService>(), get<_i5.IAuthLocalRepository>()));
  gh.factory<_i20.AuthRemoteRepository>(
      () => _i20.AuthRemoteRepository(get<_i7.IAuthRemoteService>()));
  gh.factory<_i21.ForgotPasswordBloc>(
      () => _i21.ForgotPasswordBloc(get<_i7.IAuthRemoteService>()));
  gh.lazySingleton<_i22.INoteLocalRepository>(() => _i23.NoteLocalRepository(
      noteLocaleService: get<_i14.NoteLocalService>()));
  gh.lazySingleton<_i24.ITimeLocalRepository>(
      () => _i25.TimeLocalRepository(get<_i17.TimeLocalService>()));
  gh.factory<_i26.NoteActionBloc>(
      () => _i26.NoteActionBloc(get<_i22.INoteLocalRepository>()));
  gh.factory<_i27.NoteFormBloc>(
      () => _i27.NoteFormBloc(get<_i22.INoteLocalRepository>()));
  gh.factory<_i28.NoteWatcherBloc>(
      () => _i28.NoteWatcherBloc(get<_i22.INoteLocalRepository>()));
