...
import 'application/auth/authBloc/auth_bloc.dart' as _i12;
import 'application/auth/forgotPasswordBloc/forgot_password_bloc.dart' as _i13;
...
import 'application/note/noteWatcherBloc/note_watcher_bloc.dart' as _i10;
...
import 'infrastructure/core/infrastructure_injectable_module.dart' as _i14;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i11.RegisterAndLoginBloc>(
      () => _i11.RegisterAndLoginBloc(get<_i5.IAuthRepository>()));
  gh.factory<_i12.AuthBloc>(() => _i12.AuthBloc(get<_i5.IAuthRepository>()));
  gh.factory<_i13.ForgotPasswordBloc>(
      () => _i13.ForgotPasswordBloc(get<_i5.IAuthRepository>()));
  return get;
}

class _$InfrastructureInjectableModule
    extends _i14.InfrastructureInjectableModule {}
