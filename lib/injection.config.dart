...
import 'application/auth/authBloc/auth_bloc.dart' as _i13;
import 'application/auth/forgotPasswordBloc/forgot_password_bloc.dart' as _i14;
...
import 'infrastructure/core/infrastructure_injectable_module.dart' as _i15;
...
_i1.GetIt $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i13.AuthBloc>(() => _i13.AuthBloc(get<_i5.IAuthRepository>()));
  gh.factory<_i14.ForgotPasswordBloc>(
      () => _i14.ForgotPasswordBloc(get<_i5.IAuthRepository>()));
  return get;
}

class _$InfrastructureInjectableModule
    extends _i15.InfrastructureInjectableModule {}
