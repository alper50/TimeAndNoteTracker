...
class RegisterAndLoginEvent with _$RegisterAndLoginEvent {
  ...
  const factory RegisterAndLoginEvent.resetPassword(String password) = ResetPassword;
  const factory RegisterAndLoginEvent.forgotPassword(String email) = ForgotPassword;
