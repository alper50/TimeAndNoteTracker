...
mixin _$AnalyzeEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function() changeDateToday,
    required TResult Function() changeDateYesterday,
    required TResult Function() changeDateThisWeek,
    required TResult Function() changeDateLastWeek,
    required TResult Function() changeDateThisMonth,
    required TResult Function() changeDateLastMonth,
    required TResult Function() changeDateThisYear,
  }) =>
  ...
  TResult map<TResult extends Object?>({
    ...
    required TResult Function(_ChangeDateToday value) changeDateToday,
    required TResult Function(_ChangeDateYesterday value) changeDateYesterday,
    required TResult Function(ChangeDateThisWeek value) changeDateThisWeek,
    required TResult Function(_ChangeDateLastWeek value) changeDateLastWeek,
    required TResult Function(_ChangeDateThisMonth value) changeDateThisMonth,
    required TResult Function(_ChangeDateLastMonth value) changeDateLastMonth,
    required TResult Function(_ChangeDateThisYear value) changeDateThisYear,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
class _$_ChangeDateToday implements _ChangeDateToday {
  const _$_ChangeDateToday();

  @override
  String toString() {
    return 'AnalyzeEvent.changeDateToday()';
  }
...
abstract class _ChangeDateToday implements AnalyzeEvent {
  const factory _ChangeDateToday() = _$_ChangeDateToday;
}
...
class _$_ChangeDateYesterday implements _ChangeDateYesterday {
  const _$_ChangeDateYesterday();

  @override
  String toString() {
    return 'AnalyzeEvent.changeDateYesterday()';
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    return changeDateYesterday(this);
  }
...
abstract class _ChangeDateYesterday implements AnalyzeEvent {
  const factory _ChangeDateYesterday() = _$_ChangeDateYesterday;
}
...
class _$ChangeDateThisWeek implements ChangeDateThisWeek {
  const _$ChangeDateThisWeek();

  @override
  String toString() {
    return 'AnalyzeEvent.changeDateThisWeek()';
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    return changeDateThisWeek(this);
  }
...
abstract class ChangeDateThisWeek implements AnalyzeEvent {
  const factory ChangeDateThisWeek() = _$ChangeDateThisWeek;
}
...
class _$_ChangeDateLastWeek implements _ChangeDateLastWeek {
  const _$_ChangeDateLastWeek();

  @override
  String toString() {
    return 'AnalyzeEvent.changeDateLastWeek()';
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    return changeDateLastWeek(this);
  }
...
abstract class _ChangeDateLastWeek implements AnalyzeEvent {
  const factory _ChangeDateLastWeek() = _$_ChangeDateLastWeek;
}
...
class _$_ChangeDateThisMonth implements _ChangeDateThisMonth {
  const _$_ChangeDateThisMonth();

  @override
  String toString() {
    return 'AnalyzeEvent.changeDateThisMonth()';
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    return changeDateThisMonth(this);
  }
...
abstract class _ChangeDateThisMonth implements AnalyzeEvent {
  const factory _ChangeDateThisMonth() = _$_ChangeDateThisMonth;
}
...
class _$_ChangeDateLastMonth implements _ChangeDateLastMonth {
  const _$_ChangeDateLastMonth();

  @override
  String toString() {
    return 'AnalyzeEvent.changeDateLastMonth()';
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    return changeDateLastMonth(this);
  }
...
abstract class _ChangeDateLastMonth implements AnalyzeEvent {
  const factory _ChangeDateLastMonth() = _$_ChangeDateLastMonth;
}
...
class _$_ChangeDateThisYear implements _ChangeDateThisYear {
  const _$_ChangeDateThisYear();

  @override
  String toString() {
    return 'AnalyzeEvent.changeDateThisYear()';
  }
  ...
  TResult map<TResult extends Object?>({
    ...
    return changeDateThisYear(this);
  }
...
abstract class _ChangeDateThisYear implements AnalyzeEvent {
  const factory _ChangeDateThisYear() = _$_ChangeDateThisYear;
}
...
abstract class $AnalyzeStateCopyWith<$Res> {
  ...
  $Res call(
      ...
      int selectedChip,
      Analyze analyze,
      Option<AnalyzeFailure> analyzeFailureOrSuccessOption});
...
class _$_AnalyzeState implements _AnalyzeState {
  const _$_AnalyzeState(
      ...
      required this.analyzeFailureOrSuccessOption});
  ...
  @override
  final Option<AnalyzeFailure> analyzeFailureOrSuccessOption;

  @override
  String toString() {
    return 'AnalyzeState(isInitializing: $isInitializing, isChangingDateScope: $isChangingDateScope, isAnalyzeEmpty: $isAnalyzeEmpty, selectedChip: $selectedChip, analyze: $analyze, analyzeFailureOrSuccessOption: $analyzeFailureOrSuccessOption)';
  }
...
abstract class _AnalyzeState implements AnalyzeState {
  const factory _AnalyzeState(
      ...
      required final int selectedChip,
      required final Analyze analyze,
      required final Option<AnalyzeFailure>
