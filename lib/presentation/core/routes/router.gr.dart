...
class MyRouter extends _i14.RootStackRouter {
  ...
  final Map<String, _i14.PageFactory> pagesMap = {
    ...
    AuthenticationView.name: (routeData) {
      ...
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i3.AuthenticationView(key: args.key),
      );
    },
    ...
    HomeView.name: (routeData) {
      ...
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: _i10.HomeView(key: args.key),
      );
    },
    NoteOverview.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i11.NoteOverview(),
      );
    },
    TimeListView.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i12.TimeListView(),
      );
    },
    AnalyseView.name: (routeData) {
      return _i14.MaterialPageX<dynamic>(
        routeData: routeData,
        child: const _i13.AnalyseView(),
      );
    },
  };
...
class TimeView extends _i14.PageRouteInfo<TimeViewArgs> {
  TimeView({
    _i15.Key? key,
    required _i18.Time? currentTime,
  }) : super(
          TimeView.name,
          path: '/time-view',
          args: TimeViewArgs(
